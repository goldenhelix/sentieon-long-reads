...
task pbmm2_align_wgs {
  ...
  Int threads   = 24 # GH: parameterize
  ...
  runtime {
    docker: "~{runtime_attributes.container_registry}/pbmm2:1.16.99_build1" # @sha256:b58eef0645dd9adca850c9b4811f289ddcd57f630596d9f524701bc787467f30"
    cpu: threads
    memory: mem_gb + " GB"
    disk: disk_size + " GB"
